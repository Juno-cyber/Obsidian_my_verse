...
const sortFileListClickHandle = (params) => {
    ...
    addMenuItem('文件名', 'A', 'Z', 'name');
    addMenuItem('创建时间', '新', '旧', 'created');
    addMenuItem('文件大小', '大', '小', 'file-size');
    addMenuItem('更新时间', '新', '旧', 'last-update');
...
const triggerContextMenu = (params) => {
    ...
    fileMenu.addItem((menuItem) => {
        ...
        if (isAlreadyPinned)
            menuItem.setTitle('解除固定');
        else
            menuItem.setTitle('固定到顶部');
        menuItem.onClick((ev) => {
            if (isAlreadyPinned) {
            ...
            React.createElement("div", { className: "oz-explorer-container" },
                React.createElement("div", { className: `oz-file-tree-header-wrapper${plugin.settings.fixedHeaderInFileList ? ' file-tree-header-fixed' : ''}` },
                    ...
                    searchBoxVisible && (React.createElement("div", { className: "oz-input-container" },
                        React.createElement("input", { type: "search", placeholder: "搜索...", ref: searchInput, value: searchPhrase, onChange: (e) => {
                                handleSearch({
                                    e,
                                    plugin,
                                    activeFolderPath: activeFolderPath$1,
...
class FileTreeAlternativePluginSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            .setName('印象笔记视图')
            .setDesc('如果要在单个视图中查看文件夹和文件而不在视图之间切换，请启用此选项。与印象笔记类似的体验。')
        ...
        new obsidian.Setting(containerEl)
            .setName('功能区图标')
            .setDesc('如果希望使用功能区图标激活文件树，请启用此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('打开时启动')
            .setDesc("如果不希望在库启动期间自动打开文件树视图，请关闭此选项")
        ...
        new obsidian.Setting(containerEl)
            .setName('书签事件监听器 (Shift + 单击)')
            .setDesc('这将允许从核心书签插件中显示文件或文件夹。' +
            '由于还没有API来覆盖Bookmarks插件的默认行为，' +
            '如果您使用shift单击书签名称，这将添加一个事件来显示文件')
        ...
        containerEl.createEl('h2', { text: '文件夹窗格设置' });
        new obsidian.Setting(containerEl)
            .setName('文件夹图标')
            .setDesc('更改您首选的默认文件夹图标')
            .addDropdown((dropdown) => {
            dropdown
        ...
        new obsidian.Setting(containerEl)
            .setName('显示根文件夹')
            .setDesc(`如果你想要你的根文件夹，请打开 "${this.plugin.app.vault.getName()}" 在文件树中可见`)
        ...
        new obsidian.Setting(containerEl)
            .setName('文件夹计数')
            .setDesc('如果要查看文件树下的笔记/文件数量，请启用此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('文件夹注释')
            .setDesc(`如果要创建与文件夹注释插件相同的文件夹注释，请启用此选项。 
                默认情况下，单击将打开文件列表。您需要使用“Shift+Click”打开文件夹注释。如果文件夹有文件夹注释， 
                您将在文件夹的右侧看到一个箭头图标。作为文件夹注释创建的注释隐藏在文件列表中。`)
            .addToggle((toggle) => {
        ...
        /* ------------- File Pane Settings ------------- */
        containerEl.createEl('h2', { text: '文件窗格设置' });
        new obsidian.Setting(containerEl)
            .setName('将子文件夹中的文件包含到文件列表中')
            .setDesc(`如果您想查看除所选文件夹外的所有子文件夹中的文件列表，请启用此选项`)
        ...
        new obsidian.Setting(containerEl)
            .setName('用于从子文件夹中包含文件的切换按钮')
            .setDesc(`如果您想在文件列表顶部有一个额外的按钮来切换，请启用此选项 "包含子文件夹中的文件"`)
        ...
        new obsidian.Setting(containerEl)
            .setName('“在文件树中显示活动文件”按钮')
            .setDesc(`如果您想有一个额外的按钮来显示文件树中的活动文件，请启用此选项。它将相应地设置文件夹和文件窗格。`)
        ...
        new obsidian.Setting(containerEl)
            .setName('在文件列表中搜索')
            .setDesc(`如果要启用按名称筛选文件的搜索功能，请启用此选项。`)
        ...
        new obsidian.Setting(containerEl)
            .setName('仅在焦点文件夹中进行所有标签搜索')
            .setDesc(`"all:" 和 "tag:" 默认情况下，搜索会查找库中的所有文件。如果您只想在聚焦文件夹中搜索，请启用此选项`)
        ...
        new obsidian.Setting(containerEl)
            .setName('文件名前的图标')
            .setDesc('如果要在文件列表中的文件名前显示文件图标，请启用此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('悬停时预览文件')
            .setDesc('如果您想在按住 Ctrl/Cmd 按钮的文件列表中将鼠标悬停在文件上后预览文件，请启用此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('文件窗格中的固定按钮和标题')
            .setDesc('如果您不希望按钮和标题在文件列表中滚动，请启用此选项。')
        ...
        new obsidian.Setting(containerEl)
            .setName('将文件名显示为完整路径')
            .setDesc('如果您想查看文件名列表中的完整路径，而不仅仅是文件名，请启用此选项')
            .addToggle((toggle) => {
        ...
        containerEl.createEl('p', { text: '以下设置仅适用于使用插件文件窗格中的加号（+）按钮的情况。' });
        new obsidian.Setting(containerEl)
            .setName('在YAML中创建信息')
            .setDesc('选择文件删除后要移动到的位置')
            .addToggle((toggle) => {
        ...
        new obsidian.Setting(containerEl)
            .setName('将文件名设置为标题1')
            .setDesc('如果您希望插件在创建的文件中将初始文件名添加为主标题，请启用此选项。')
            .addToggle((toggle) => {
        ...
        new obsidian.Setting(containerEl)
            .setName('隐藏附件')
            .setDesc(`它会隐藏 "附件" 从视图中删除文件夹，并从文件列表中删除此文件夹下的任何文件`)
        ...
        new obsidian.Setting(containerEl)
            .setName('排除的文件扩展名')
            .setDesc(`提供要从文件树列表中排除的文件的扩展名，用逗号分隔。 例如 'png, pdf, jpeg'.
            您需要重新加载库或使用 "重新加载文件树" 单击下面的按钮使更改生效。`)
        ...
        new obsidian.Setting(containerEl)
            .setName('排除的文件夹路径')
            .setDesc(`提供要从文件树列表中排除的文件夹的完整路径，用逗号分隔。即 'Personal/Attachments, Work/Documents/Folders'.
            所有子文件夹也将被排除在外。您需要重新加载vault或使用下面的 "重新加载文件树" 按钮使更改生效。`)
            .addTextArea((text) => text.setValue(this.plugin.settings.excludedFolders).onChange((value) => {
            this.plugin.settings.excludedFolders = value;
            this.plugin.saveSettings();
        }));
        new obsidian.Setting(containerEl)
            .setDesc('使用此按钮重新加载文件树。某些设置需要重新加载文件树。您也可以重新启动vault以获得相同的效果。')
            .addButton((button) => {
            button
                .setClass('reload-file-tree-button')
                .setTooltip('单击此处重新加载文件树')
        ...
        new obsidian.Setting(containerEl)
            .setName('清除所有缓存数据')
            .setDesc(`此按钮将清除以下缓存数据: "分隔器的最后位置" & "文件夹窗格中展开的文件夹列表", 
                & "文件夹窗格中展开的文件夹列表". 它不会触及您上面的设置和固定文件列表。建议偶尔进行一次清理。`)
            .addButton((button) => {
            button
                .setTooltip('单击此处清除缓存数据')
        ...
        new obsidian.Setting(containerEl)
            .setName('清除固定文件')
            .setDesc(`此按钮将清除文件列表窗格中的固定文件。`)
            .addButton((button) => {
            button
                .setTooltip('单击此处清除固定文件')
                .setButtonText('单击清除固定文件')
                .onClick(() => __awaiter(this, void 0, void 0, function* () {
    ...
    constructor() {
        ...
        this.refreshIconRibbon = () => {
            ...
            if (this.settings.ribbonIcon) {
                this.ribbonIconEl = this.addRibbonIcon(this.ICON, '文件树替代插件', () => __awaiter(this, void 0, void 0, function* () {
